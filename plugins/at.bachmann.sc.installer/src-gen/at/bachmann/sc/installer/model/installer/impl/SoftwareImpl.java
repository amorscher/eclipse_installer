 ...
 * </p>
 * <ul>
 *   <li>{@link at.bachmann.sc.installer.model.installer.impl.SoftwareImpl#getName <em>Name</em>}</li>
 *   <li>{@link at.bachmann.sc.installer.model.installer.impl.SoftwareImpl#getComponents <em>Components</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SoftwareImpl extends MinimalEObjectImpl.Container implements Software {
	...
	protected EClass eStaticClass() {
		return InstallerPackage.Literals.SOFTWARE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InstallerPackage.SOFTWARE__NAME, oldName, name));
	}
	...
	public EList<InstallableComponent> getComponents() {
		if (components == null) {
			components = new EObjectContainmentEList<InstallableComponent>(InstallableComponent.class, this, InstallerPackage.SOFTWARE__COMPONENTS);
		}
		return components;
	}
