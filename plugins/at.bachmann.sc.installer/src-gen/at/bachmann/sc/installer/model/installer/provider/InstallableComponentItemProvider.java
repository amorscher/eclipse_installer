/**
 */
package at.bachmann.sc.installer.model.installer.provider;
...
/**
 * This is the item provider adapter for a {@link at.bachmann.sc.installer.model.installer.InstallableComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstallableComponentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InstallerPackage.Literals.INSTALLABLE_COMPONENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addFeaturesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InstallableComponent_features_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InstallableComponent_features_feature", "_UI_InstallableComponent_type"),
				 InstallerPackage.Literals.INSTALLABLE_COMPONENT__FEATURES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InstallerPackage.Literals.INSTALLABLE_COMPONENT__SUB_COMPONENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(InstallerPackage.Literals.INSTALLABLE_COMPONENT__SUB_COMPONENTS,
				 InstallerFactory.eINSTANCE.createInstallableComponent()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return InstallerEditPlugin.INSTANCE;
	}
